...
if __name__ == "__main__":
    ...
    low_task    = Task(0x0008, 0x04, [(0x02, TYPES.UINT8), (0x05, TYPES.UINT16)])
    mid_task    = Task(0x0008, 0x04, [(0x50, TYPES.UINT8), (0x05, TYPES.UINT16)])
    high_task   = Task(0x0008, 0x04, [(0xFD, TYPES.UINT8), (0x05, TYPES.UINT16)])
